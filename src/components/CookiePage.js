  ...
  return (
    <>
      <div className="privateCookie">
        ...
        <p>
          {" "}
          Administratorem Pani/Pana danych osobowych jest Jarosław Janas, 31-222
          Kraków, adres e-mail: jarekjanas95@gmail.com tel. 798 194 305.{" "}
        </p>
        <p>
          {" "}
        ...
        <p>
          {" "}
          Nasza strona internetowa dzarek-portfolio.netlify.app nie zbiera w
          sposób automatyczny żadnych informacji, z wyjątkiem informacji
          zawartych w plikach cookies. Więcej o plikach cookies (tzw.
